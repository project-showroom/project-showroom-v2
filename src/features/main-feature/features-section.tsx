...
const FeaturesSection = ({
  ...
  const darkBg =
    'dark:bg-gradient-to-r dark:from-sky-200 dark:via-sky-600 dark:to-sky-400';
      ...
      >
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-base leading-7 text-gray-600 dark:text-gray-800 sm:mt-8 font-pj">
          ...
          <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:gap-0 xl:mt-24">
            <div className="md:p-8 lg:p-14">
              ...
              <p className="mt-5 text-base text-gray-600 dark:text-gray-800 font-pj">
